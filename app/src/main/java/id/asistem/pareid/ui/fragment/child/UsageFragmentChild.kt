...
class UsageFragmentChild : Fragment(), ClickListener {
    ...
    override fun onCreateView(
        ...
        val v: View = inflater.inflate(R.layout.fragment_usage_child, container, false)
    ...
    private fun init(v: View) {
        val swipe: SwipeRefreshLayout = v.findViewById(R.id.swUsageFragmentChild)
        progressBar = v.findViewById(R.id.pbUsageFragmentChild)
    ...
    private fun bindView(v: View) {
        line = v.findViewById(R.id.lcvUsageChild)
        recycler = v.findViewById(R.id.rvUsageChild)
        val usage = db.getUsageDao().getAllUsage()
